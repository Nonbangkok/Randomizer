  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        diceRoller: resolve(__dirname, 'tools/dice-roller/index.html'),
        ...
        blogGachaPsychology: resolve(__dirname, 'blog/gacha-psychology.html'),
        blogDndMath: resolve(__dirname, 'blog/dnd-mathematics.html'),
        blogClientPrivacy: resolve(__dirname, 'blog/client-side-privacy.html'),
        blogAnalysisParalysis: resolve(__dirname, 'blog/analysis-paralysis-games.html'),
        blogWritersBlock: resolve(__dirname, 'blog/random-generation-writers-block.html'),
      },
    },
  },
});
